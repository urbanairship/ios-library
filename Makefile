...
export TEST_DESTINATION ?= platform=iOS Simulator,OS=latest,name=iPad (10th generation)
export TEST_DESTINATION_TVOS ?= platform=tvOS Simulator,OS=18.4,name=Apple TV
