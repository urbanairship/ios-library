...
# Package AirshipFoundationModels
xcrun xcodebuild -create-xcframework \
  -framework "$ARCHIVE_PATH/xcarchive/AirshipRelease/iphoneos.xcarchive/Products/Library/Frameworks/AirshipFoundationModels.framework" \
  -debug-symbols "$FULL_ARCHIVE_PATH/xcarchive/AirshipRelease/iphoneos.xcarchive/dSYMs/AirshipFoundationModels.framework.dSYM" \
  -framework "$ARCHIVE_PATH/xcarchive/AirshipRelease/iphonesimulator.xcarchive/Products/Library/Frameworks/AirshipFoundationModels.framework" \
  -debug-symbols "$FULL_ARCHIVE_PATH/xcarchive/AirshipRelease/iphonesimulator.xcarchive/dSYMs/AirshipFoundationModels.framework.dSYM" \
  -framework "$ARCHIVE_PATH/xcarchive/AirshipRelease/xros.xcarchive/Products/Library/Frameworks/AirshipFoundationModels.framework" \
  -debug-symbols "$FULL_ARCHIVE_PATH/xcarchive/AirshipRelease/xros.xcarchive/dSYMs/AirshipFoundationModels.framework.dSYM" \
  -framework "$ARCHIVE_PATH/xcarchive/AirshipRelease/xrsimulator.xcarchive/Products/Library/Frameworks/AirshipFoundationModels.framework" \
  -debug-symbols "$FULL_ARCHIVE_PATH/xcarchive/AirshipRelease/xrsimulator.xcarchive/dSYMs/AirshipFoundationModels.framework.dSYM" \
  -framework "$ARCHIVE_PATH/xcarchive/AirshipRelease/mac.xcarchive/Products/Library/Frameworks/AirshipFoundationModels.framework" \
  -debug-symbols "$FULL_ARCHIVE_PATH/xcarchive/AirshipRelease/mac.xcarchive/dSYMs/AirshipFoundationModels.framework.dSYM" \
  -output "$OUTPUT_FULL/AirshipFoundationModels.xcframework"
...
# Package AirshipFoundationModels (.NET)
xcrun xcodebuild -create-xcframework \
  -framework "$ARCHIVE_PATH/xcarchive/AirshipRelease/iphoneos.xcarchive/Products/Library/Frameworks/AirshipFoundationModels.framework" \
  -framework "$ARCHIVE_PATH/xcarchive/AirshipRelease/iphonesimulator.xcarchive/Products/Library/Frameworks/AirshipFoundationModels.framework" \
  -framework "$ARCHIVE_PATH/xcarchive/AirshipRelease/mac.xcarchive/Products/Library/Frameworks/AirshipFoundationModels.framework" \
  -output "$OUTPUT_DOTNET/AirshipFoundationModels.xcframework"
...
if [ "$SKIP_SIGNING" != "true" ]; then
  ...
  codesign --timestamp -v --sign "Apple Distribution: Urban Airship Inc. (PGJV57GD94)" "$OUTPUT_FULL/AirshipFoundationModels.xcframework"
  ...
  codesign --timestamp -v --sign "Apple Distribution: Urban Airship Inc. (PGJV57GD94)" "$OUTPUT_DOTNET/AirshipFoundationModels.xcframework"
