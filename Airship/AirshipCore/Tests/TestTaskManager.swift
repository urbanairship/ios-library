...
public class TestTaskManager: NSObject, TaskManagerProtocol {
    ...
    private var launchHandlers:
        [String: (UADispatcher, (AirshipTask) -> Void)] =
            [:]
    ...
    public func setRateLimit(
        ...
        rateLimits[rateLimitID] = RateLimit(
            rate: rate,
            timeInterval: timeInterval
        )
    }
    ...
    public func register(
        taskID: String,
        type: AirshipCore.AirshipWorkerType,
        launchHandler: @escaping (AirshipCore.AirshipTask) -> Void
    ) {
        self.register(
            taskID: taskID,
            type: type,
    ...
    public func register(
        taskID: String,
        type: AirshipCore.AirshipWorkerType,
        dispatcher: AirshipCore.UADispatcher,
        launchHandler: @escaping (AirshipCore.AirshipTask) -> Void
    ) {
    ...
    @objc
    public func launchSync(
        taskID: String,
        options: TaskRequestOptions = TaskRequestOptions.defaultOptions
    ) -> TestTask {
