 ...
 */
@objc
public class UATaskRequestOptions : NSObject {
    @objc
    ...
    @objc
    public static let defaultOptions = UATaskRequestOptions(conflictPolicy: .replace, requiresNetwork: true)
    ...
    func isEqual(to options: UATaskRequestOptions) -> Bool {
    ...
    public override func isEqual(_ object: Any?) -> Bool {
        guard let options = object as? UATaskRequestOptions else {
            return false
        }
