 ...
 */
@objc
public class UAAssociatedIdentifiers : NSObject{
     ...
     */
    @objc
    public class func identifiers() -> UAAssociatedIdentifiers {
    ...
    public class func identifiers(identifiers: [String : String]?) -> UAAssociatedIdentifiers {
        return UAAssociatedIdentifiers(identifiers: identifiers)
    }
