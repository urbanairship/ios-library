...
@objc
public class UARequestBuilder : NSObject {
...
@objc
public class UARequest : NSObject {
    @objc
    ...
    private init(builder: UARequestBuilder) {
    ...
    @objc
    public static func request(withBuilderBlock block: @escaping (_ builder: UARequestBuilder) -> Void) -> UARequest {
        return UARequest(builderBlock: block);
    }

    @objc
    public convenience init(builderBlock: @escaping (_ builder: UARequestBuilder) -> Void) {
        let builder = UARequestBuilder()
