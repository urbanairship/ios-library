 ...
 */
@objc
public enum UADispatcherTimeBase : Int {
    /// Wall time.
    case wall
...
open class UADispatcher : NSObject {
    ...
    @objc
    @discardableResult
    open func dispatch(after delay: TimeInterval, timebase: UADispatcherTimeBase, block: @escaping () -> Void) -> UADisposable {
    ...
    @objc
    @discardableResult
    open func dispatch(after delay:TimeInterval, block: @escaping () -> Void) -> UADisposable {
