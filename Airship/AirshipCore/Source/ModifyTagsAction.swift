...
public class ModifyTagsAction: NSObject, Action {
    ...
    public func acceptsArguments(_ arguments: ActionArguments) -> Bool {
        ...
        if let dict = arguments.value as? [String: Any] {
            ...
            guard
                channelTagGroups == nil
                    || channelTagGroups is [String: [String]]
            else {
                return false
            }
            ...
            guard
                namedUserTagGroups == nil
                    || namedUserTagGroups is [String: [String]]
            else {
                return false
            }
            ...
            return deviceTags != nil || channelTagGroups != nil
                || deviceTags != nil
        }
    ...
    public func perform(
        ...
        if let tag = arguments.value as? String {
            ...
            if let tagGroups = dict[ModifyTagsAction.channelKey]
                as? [String: [String]]
            {
            ...
            if let tagGroups = dict[ModifyTagsAction.namedUserKey]
                as? [String: [String]]
            {
                if !tagGroups.isEmpty {
    ...
    open func onChannelTags(
        _ tags: [String],
        group: String,
        editor: TagGroupsEditor
    ) {}

    open func onContactTags(
        _ tags: [String],
        group: String,
        editor: TagGroupsEditor
    ) {}
