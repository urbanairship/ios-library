...
public class PreferenceCenterViewControllerFactory: NSObject {
    ...
    @objc
    public class func makeViewController(preferenceCenterID: String) -> UIViewController {
    ...
    public class func makeViewController(preferenceCenterID: String,
                                         preferenceCenterThemePlist: String) throws -> UIViewController {
    ...
    /// - Returns: A view controller.
    public class func makeViewController(preferenceCenterID: String,
                                         preferenceCenterTheme: PreferenceCenterTheme) -> UIViewController {
        let view = PreferenceCenterView(preferenceCenterID: preferenceCenterID)
        return makeViewController(
            view: view,
    ...
    ///     - preferenceCenterTheme: The theme.
    /// - Returns: A view controller.
    public class func makeViewController(view: PreferenceCenterView,
                                         preferenceCenterTheme: PreferenceCenterTheme?) -> UIViewController {
...
fileprivate class PreferenceCenterViewController<Content> : UIHostingController<Content> where Content : View {
