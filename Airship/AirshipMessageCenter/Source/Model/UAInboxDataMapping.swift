...
class UAInboxDataMapping: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(
        ...
        if sInstance.entity.name == InboxMessageData.messageDataEntity {
            ...
            newRemoteDataEntity.setValue(AirshipJSONUtils.toData(messageReporting), forKey: "messageReporting")
            ...
            newRemoteDataEntity.setValue(AirshipJSONUtils.toData(extra), forKey: "extra")
            newRemoteDataEntity.setValue(AirshipJSONUtils.toData(rawMessageObject), forKey: "rawMessageObject")
        }
    }
}
