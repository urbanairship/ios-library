...
public struct ScopedSubscriptionListsDebugView: View {
    ...
    private let editorFactory: () -> ScopedSubscriptionListEditor?

    public init(editorFactory: @escaping () -> ScopedSubscriptionListEditor?) {
