...
// To make ASIHTTPRequests use it automatically, use [UA_ASIHTTPRequest setDefaultCache:[UA_ASIDownloadCache sharedCache]];
+ (id)sharedCache;
...
// Do not use this formatter for parsing dates because the format can vary slightly - use UA_ASIHTTPRequest's dateFromRFC1123String: class method instead
