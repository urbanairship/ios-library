...
static NSString *const UAPaddingTopKey = @"top";
static NSString *const UAPaddingBottomKey = @"bottom";
static NSString *const UAPaddingTrailingKey = @"trailing";
static NSString *const UAPaddingLeadingKey = @"leading";
